...
<table width="1000" border="0">
  <tr>
    <td width="1000" height="22" align="center"><span style="font-size:18px; font-weight:bold;">DATA ANGGOTA BERDASARKAN STATUS</span></td>
    </tr>
  <tr>
    <td align="Left">&nbsp;</td>
    </tr>
...
FROM
    `simperpus`.`jenispeminjam`
    INNER JOIN `simperpus`.`anggota` 
        ON (`jenispeminjam`.`idpeminjam` = `anggota`.`status`) where `anggota`.`status` = '$status' ORDER BY `anggota`.`idanggota` ASC");
?>
<table width="1000" height="70" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#999999">
    <td width="86" height="36" align="center" bgcolor="#CCCCCC">Idanggota</td>
    <td width="236" align="center" bgcolor="#CCCCCC">Nama</td>
    <td width="227" align="center" bgcolor="#CCCCCC">Alamat</td>
    <td width="146" align="center" bgcolor="#CCCCCC">Jenis Kelamin</td>
    <td width="187" align="center" bgcolor="#CCCCCC">Tgl Lahir</td>
    <td width="104" align="center" bgcolor="#CCCCCC">Status</td>
    </tr>
