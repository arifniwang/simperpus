...
ob_start();
include "../koneksi.php";
$tglpengadaanawal = date("Y-m-d", strtotime($_GET['tglpengadaanawal']));
$tglpengadaanakhir = date("Y-m-d", strtotime($_GET['tglpengadaanakhir']));
?>
...
<table width="1000" border="0">
  <tr>
    <td width="1000" height="22" align="center"><span style="font-size:18px; font-weight:bold;">DATA BUKU BERDASARKAN PENGADAAN</span></td>
    </tr>
  <tr>
    <td align="Left">&nbsp;</td>
    </tr>
  <tr>
    <td align="Left">Periode : <?php echo date("d-M-Y", strtotime($tglpengadaanawal)); ?> s/d <?php echo date("d-M-Y", strtotime($tglpengadaanakhir)); ?></td>
    </tr>
</table><br>
<?php
...
FROM
    ...
    INNER JOIN `simperpus`.`kondisi` 
        ON (`kondisi`.`idkondisi` = `buku`.`kondisi`) where `buku`.`pengadaan` between '$tglpengadaanawal' AND
'$tglpengadaanakhir' ORDER BY `buku`.`pengadaan` ASC");
?>
<table width="1000" height="70" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#999999">
    <td width="98" align="center" bgcolor="#CCCCCC">Tgl Pengadaan</td>
    <td width="80" height="36" align="center" bgcolor="#CCCCCC">Idbuku</td>
    <td width="169" align="center" bgcolor="#CCCCCC">Judul</td>
    <td width="155" align="center" bgcolor="#CCCCCC">Penerbit</td>
    <td width="120" align="center" bgcolor="#CCCCCC">Asal Buku</td>
    <td width="120" align="center" bgcolor="#CCCCCC">Accnumber</td>
    <td width="98" align="center" bgcolor="#CCCCCC">Ket</td>
    </tr>
<?php while($data = mysqli_fetch_array($sql)) { ?>
  <tr>
    <td align="center"><?php echo date("d-M-Y", strtotime($data['tgl_pengadaan']));?></td>
    ...
    <td align="center"><?php echo $data['asalbuku'];?></td>
